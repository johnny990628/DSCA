...
class RRTEncoder(nn.Module):
    def __init__(self,mlp_dim=512,pos_pos=0,pos='ppeg',peg_k=5,attn='rmsa',region_num=4,drop_out=0.3,n_layers=1,n_heads=1,drop_path=0.,ffn=False,ffn_act='relu',mlp_ratio=4.,trans_dim=64,epeg=True,epeg_k=3,region_size=0,min_region_num=0,min_region_ratio=0,qkv_bias=True,peg_bias=True,peg_1d=False,cr_msa=True,crmsa_k=2,all_shortcut=False,crmsa_mlp=False,crmsa_heads=1,need_init=False,**kwargs):
